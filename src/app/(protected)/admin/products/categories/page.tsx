...
const [categories, setCategories] = useState<CategoryInDB[]>([]);
...
const openEditForm = (category: CategoryInDB) => {
...
const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
    if (editingId) {
        await api.put(`/products/categories/${editingId}`, payload);
...
const handleDeleteCategory = async (categoryId: number) => {
    if (!window.confirm('Are you sure you want to delete this category? Products assigned to it will be affected.')) return;
    setLoading(true);
    setError(null);
    try {
